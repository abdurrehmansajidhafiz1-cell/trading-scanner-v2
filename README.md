...
> **Last Engine Sync:** `2026-09-15 04:05 AM PKT` (`2026-09-14 23:05 UTC`) | **Cycle:** `Day 12 of 15`
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| #64 | **FIL/USDT** | `30m` | 🟡 **ACTIVE** | 🟡 In Trade ($100 (61.8%+78.6%)) | `0.9731` | `0.9562` | `0.9028` | `1.0300` | `1.0969` | 1:1.38 | 2026-09-14 08:00 PM PKT |
